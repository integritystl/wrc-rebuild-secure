...
?>
	<div class="quiz-five-star-wp-rate-action notice notice-success">
		<span class="quiz-slug"><b>Insert or Embed e-Learning Content into WordPress</b> <i><?php _e('Plugin', 'quiz')?></i></span> 
...
{
	wp_enqueue_script('quiz_rate_notice', articulate_WP_QUIZ_EMBEDER_PLUGIN_URL.'js/five_star_wp_rate_notice.js', array('jquery') );
}
