			...
			<form id="wsal-rep-form" action="<?php echo esc_url( $this->GetUrl() ); ?>" method="post">
					...
					<div class="wsal-rep-section">
						...
						<div class="wsal-rep-section-fl">
							...
							<p class="wsal-rep-clear">
								...
								<label for="wsal-rb-sites-2"><?php esc_html_e( 'Specify sites', 'wp-security-audit-log' ); ?></label>
					...
					<div class="wsal-rep-section">
						...
						<div class="wsal-rep-section-fl wsal-rep-section-users">
							...
							<p class="wsal-rep-clear">
								...
								<label for="wsal-rb-users-2"><?php esc_html_e( 'Specify users', 'wp-security-audit-log' ); ?></label>
								<?php if ( $users_count <= 100 ) : ?>
									<input type="hidden" name="wsal-rep-users" id="wsal-rep-users" />
								<?php elseif ( $users_count > 100 && '1' === $autocomplete ) : ?>
									<input type="hidden" name="wsal-rep-users" id="wsal-rep-users" />
									<?php
								else :
									$user_logins = array();
					...
					<div class="wsal-rep-section">
						...
						<div class="wsal-rep-section-fl">
							...
							<p class="wsal-rep-clear">
								...
								<label for="wsal-rb-roles-2"><?php esc_html_e( 'Specify roles', 'wp-security-audit-log' ); ?></label>
					...
					<div class="wsal-rep-section">
						...
						<div class="wsal-rep-section-fl">
							...
							<p class="wsal-rep-clear">
								...
								<label for="wsal-rb-ip-addresses-2"><?php esc_html_e( 'Specify IP Addresses', 'wp-security-audit-log' ); ?></label>
					...
					<div class="wsal-rep-section">
						...
						<div class="wsal-rep-section-fl">
							...
							<p class="wsal-rep-clear">
								...
								<label for="wsal-rb-event-objects-2"><?php esc_html_e( 'Specify Objects', 'wp-security-audit-log' ); ?></label>
								<input type="hidden" name="wsal-rep-event-objects" id="wsal-rep-event-objects"/>
							</p>
						</div>
					</div>
					...
					<div class="wsal-rep-section">
						...
						<div class="wsal-rep-section-fl">
							...
							<p class="wsal-rep-clear">
								...
								<label for="wsal-rb-event-types-2"><?php esc_html_e( 'Specify Event Types', 'wp-security-audit-log' ); ?></label>
								<input type="hidden" name="wsal-rep-event-types" id="wsal-rep-event-types"/>
							</p>
						</div>
					</div>
				...
				<script id="wpsal_rep_s2" type="text/javascript">
					jQuery( document ).ready( function( $ ) {
						...
						$('#wsal-rep-event-objects').select2({
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		$('#wsal-rep-form').on('submit', function(){
			...
			//#! Event Objects
			if(!$('#wsal-rb-event-objects-1').is(':checked')){
				e = $('#wsal-rep-event-objects').val();
				if(!e.length){
			...
			//#! Event types
			if(!$('#wsal-rb-event-types-1').is(':checked')){
				e = $('#wsal-rep-event-types').val();
				if(!e.length){
