...
class WSAL_NP_EditNotification extends WSAL_AbstractView {
	...
	public function Header() {
		...
		<?php
		wp_enqueue_script(
			'jquery-date-time-pick-plugin-js',
	...
	public function Render() {
		...
		<div class="wrap">
			...
			<script type="text/template" id="scriptEmail">
				...
				<p class="description"><?php esc_html_e( 'Specify the email address or WordPress usernames who should receive the notification once the trigger is matched. To specify multiple email addresses or usernames separate them with a comma (,).', 'wp-security-audit-log' ); ?></p>
