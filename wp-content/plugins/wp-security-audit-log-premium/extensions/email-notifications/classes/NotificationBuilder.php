...
class WSAL_NP_NotificationBuilder {
	...
	public function __construct() {
		...
		$this->email_label        = __( 'Email Address(es) or WordPress Users:', 'wp-security-audit-log' );
		$this->phone_label        = __( 'Phone number(s) for SMS notifications:', 'wp-security-audit-log' );
