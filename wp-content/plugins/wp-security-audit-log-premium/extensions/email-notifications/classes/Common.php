...
class WSAL_NP_Common {
     ...
     *
     * @deprecated 4.1.3
	 * @see WSAL_NP_Common::AddGlobalSetting()
	 */
     ...
     *
     * @deprecated 4.1.3
     * @see WSAL_NP_Common::UpdateGlobalSetting()
	 */
     ...
     *
     * @deprecated 4.1.3
     * @see WSAL_NP_Common::DeleteGlobalSetting()
	 */
     ...
     *
     * @deprecated 4.1.3
     * @see WSAL_NP_Common::GetSettingByName()
	 */
	 ...
	 * @return boolean passed limit true|false
	 */
	public function Is404Limit( $limit, $site_id, $username, $ip, $exceed = false, $alert_code = null ) {
		$get_fn = $this->wsal->IsMultisite() ? 'get_site_transient' : 'get_transient';
		// More than limit.
		$limit += 2;
	 ...
	 */
	final public function set_html_content_type() {
		return 'text/html';
	}
	...
	public function get_bitly_group_guid( $bitly_token ) {
		$group_guid_trans = WpSecurityAuditLog::OPT_PRFX . 'bitly_group_guid';
	...
	public function get_alert_severity( $alert_id ) {
		...
		if ( $alert instanceof WSAL_Alert ) {
			$severity_obj = $this->wsal->constants->GetConstantBy( 'value', $alert->code );
